...
-- MAGIC %md 
-- MAGIC Open the FSI banking & Fraud  <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/c8083360-9492-446d-9293-e648527c85eb" target="_blank">Spark Declarative Pipeline</a> or the [SQL notebook]($./01-Data-ingestion/01.1-DLT-fraud-detection-SQL) *(Alternatives: SDP Python version Soon available)*. <br>
-- MAGIC   For more details on SDP: `dbdemos.install('dlt-loans')` or `dbdemos.install('dlt-cdc')`
